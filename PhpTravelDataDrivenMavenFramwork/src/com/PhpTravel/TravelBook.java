...
import SnapShotUtility.SnapshotUtilty;
    ...
    public class TravelBook {
        ...
        public void init() throws Exception {
        	...
        	//---------------------config propery file--------------------------------------------
        	prop=new Properties();
        	FileInputStream configFile=new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\Configuration\\TravelConfig.properties");
        ...
        //public static void bookTicket(String username,String password, String tax, int services,String registered,String CustNameValue,String cars,String Deposit,String paymentMethod,String dashBord) throws InterruptedException 
        public static void bookTicket(String username,String password,String tax,String services,String registered,String CustNameValue,String Dates,String cars,String Deposit,String paymentMethod,String dashBord) throws InterruptedException, Exception {
            ...
            for (int i = 1; i <= col.size(); i++) {
                ...
                if (S.equals("23")) {
                    ...
                    driver.findElement(By.xpath(".//*[@id='49']/i")).click();
